...
const ProductLists: React.FC<ProductProps> = ({data, title, slider=false, pagination}) => {
  ...
  const nextPage = () => {
    ...
    <div className='mt-6 lg:col-span-4 lg:mt-0'>
       <h3 className=' relative font-extrabold mb-12  lg:text-3xl md:text-3xl text-3xl sm:text-2xl text-center after:bg-orange after:w-[100px] after:h-2 after:rounded-md after:absolute after:-bottom-0 after:left-[50%] after:translate-x-[-50%] leading-[80px]'>{title}</h3>
